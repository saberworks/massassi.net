...
?>
	...
	<script type="text/javascript" src="styles2.js"></script>
	<script type="text/javascript" src="imgpop.js"></script>
...
// only allow word characters in $x, to hopefuly save from directory
// traversal attacks
$x = preg_replace('/\W/', '', $x);
